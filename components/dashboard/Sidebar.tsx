...
import { LayoutDashboard, FileText, FolderOpen, Receipt, LogOut, Settings, Users, Home, Zap } from 'lucide-react'
    ...
    <aside className="w-56 bg-white border-r border-gray-100 flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-gray-100 space-y-0.5">
        ...
        <div className="px-3 pt-3">
          ...
          {isAdmin && (
            <span className="inline-block mt-1 text-xs bg-brand-50 text-brand-600 font-medium px-1.5 py-0.5 rounded">Admin</span>
          )}
        </div>
      </div>
    </aside>
