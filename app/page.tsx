      ...
      <section className="bg-gray-900 py-20">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-3 flex-shrink-0">
            ...
            <a href="mailto:support@klovex.app" className="btn-secondary py-3 px-8 text-base bg-transparent border-gray-700 text-gray-300 hover:bg-gray-800">
              Book a demo
            </a>
          </div>
        </div>
      ...
      <footer className="border-t border-gray-100 py-8">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between text-sm">
          ...
          <div className="flex gap-6 text-gray-400">
            ...
            <a href="mailto:support@klovex.app" className="hover:text-gray-600">Contact</a>
          </div>
        </div>
      </footer>
    </div>
