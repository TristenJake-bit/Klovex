      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>You can request full deletion of your account and all associated data at any time by emailing <a href="mailto:hello@klovex.app" className="text-brand-500 hover:text-brand-600 underline">hello@klovex.app</a>. We'll process your request within 30 days.</p>
          </section>
        </div>
      </div>
    </div>
