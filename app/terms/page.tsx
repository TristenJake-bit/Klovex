      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>Questions about these terms? Reach out at <a href="mailto:support@klovex.app" className="text-brand-500 hover:text-brand-600 underline">support@klovex.app</a>.</p>
          </section>
        </div>
      </div>
    </div>
