...
export default async function PlansPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        'Up to 4 transactions included ($200/deal)',
        'Priority support',
    ...
    },
    {
      ...
      features: [
        ...
        'Up to 15 transactions included ($100/deal)',
  ...
  return (
    <div className="p-8 max-w-6xl">
      <div className="mb-10">
        <h1 className="text-2xl font-semibold text-gray-900">Plans & Pricing</h1>
        <p className="text-gray-400 text-sm mt-1">Simple, transparent pricing. No hidden fees. Cancel anytime.</p>
      </div>
          ...
          <div key={plan.name} className={`card p-6 relative flex flex-col ${plan.featured ? 'ring-2 ring-brand-500' : ''}`}>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-end gap-1.5 mb-1">
                ...
                {plan.price !== 'Custom' && <span className="text-gray-400 text-sm mb-1">/{plan.per.split(' ')[0].replace('per', '').trim() || 'transaction'}</span>}
              </div>
